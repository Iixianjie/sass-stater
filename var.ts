...
export const black = {
  title: 'rgba(0, 0, 0, 0.9)', // Title
  primary: ' rgba(0, 0, 0, 0.75)', // 主要文本色
  second: 'rgba(0, 0, 0, 0.45)', // 次要文本色
  disable: 'rgba(0, 0, 0, 0.25)', // 禁用
  border: 'rgba(0, 0, 0, 0.15)', // 边框/分割线
  bg: 'rgba(0, 0, 0, 0.04)', // 背景色
}

export const white = {
  title: 'rgba(255, 255, 255, 1)', // Title
  primary: 'rgba(255, 255, 255, 0.85)', // 主要文本色
  second: 'rgba(255, 255, 255, 0.65)', // 次要文本色
  disable: 'rgba(255, 255, 255, 0.45)', // 禁用
  border: 'rgba(255, 255, 255, 0.25)', // 边框/分割线
  bg: 'rgba(255, 255, 255, 0.09)', // 背景色
}
